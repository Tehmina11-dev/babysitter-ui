...
const OurMission = () => {
  return (
    <section className="bg-background py-16 px-4">
      ...
      <div className="max-w-7xl mx-auto bg-light/50 rounded-xl3 p-8 md:p-16 text-center relative overflow-hidden">
        
        {/* Title */}
        <h2 className="font-heading text-[48px] font-semibold leading-[100%] tracking-[0em] text-primary mb-8">
          Our Mission
        </h2>

        {/* Mission Text */}
        <p className="font-sans text-[22px] font-normal leading-[1.6] tracking-[0.01em] text-gray max-w-4xl mx-auto mb-12">
        ...
        {/* Signature Section */}
        <div className="relative inline-block mb-12 text-left">
          <p className="font-heading text-[24px] font-semibold leading-[100%] tracking-[0em] text-primary">
            With love & care,
          </p>
          <p className="font-sans text-[18px] font-normal leading-[1.6] tracking-[0.01em] text-gray">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="bg-primary text-white font-sans text-[18px] font-semibold leading-[100%] tracking-[0.01em] py-4 px-10 rounded-full hover:brightness-105 transition-all shadow-card">
            Parents registration
          </button>
          <button className="bg-[#ffb533]/30 text-primary font-sans text-[18px] font-semibold leading-[100%] tracking-[0.01em] py-4 px-10 rounded-full hover:bg-light transition-all">
            Sitter registration
          </button>
        </div>
